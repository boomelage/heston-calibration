...
artefacts stay tracked: the `price`-objective baseline under `results/calibrations/price/`
(`calibrations.csv`, `rejections.csv`, `validation.csv`) and the market rates in `data/market/`.
