...
- `results/calibrations/<objective>/calibration_tests/` — per-day repricing diagnostics (one file per
...
objective (`results/calibrations/vol/`) and the market rates in `data/market/`. The `price` objective
