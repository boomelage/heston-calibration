...
3. Run [`extract_otms.py`](data/extract_otms.py) to clean the data and extract only $\emph{out-of-the-money}$ options
4. Run [`calibrator_prototype.py`](src/calibrator_prototype.py)
